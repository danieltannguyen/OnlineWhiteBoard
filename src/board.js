...
function init () {
  ...
  setStatus("Connecting to Whiteboard Server...");
}
...
/**
 ...
 document.getElementById("000000").onchange = colorSelectListener;
  document.getElementById("F34336").onchange = colorSelectListener;
  document.getElementById("4CAF50").onchange = colorSelectListener;
  document.getElementById("2196F3").onchange = colorSelectListener;
  document.getElementById("FFC107").onchange = colorSelectListener;
  document.getElementById("9C27B0").onchange = colorSelectListener;
  document.getElementById("E91E63").onchange = colorSelectListener;
  document.getElementById("795548").onchange = colorSelectListener;
  */
